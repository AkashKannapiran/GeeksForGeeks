<h2><a href="https://www.geeksforgeeks.org/problems/biginteger-multiply/1?page=1&status=solved&sortBy=latest">BigInteger Multiply</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two BigIntegers <strong>X</strong> and <strong>Y</strong>. You have&nbsp;to multiply X and Y.</span></p>
