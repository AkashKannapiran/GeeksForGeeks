<h2><a href="https://www.geeksforgeeks.org/problems/gray-to-binary-equivalent-1587115620/1?page=1&category=Bit%20Magic&sortBy=accuracy">Gray to Binary equivalent</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a integer number&nbsp;<strong>n</strong> in <span style="text-decoration: underline;"><a href="https://www.geeksforgeeks.org/what-is-gray-code/"><strong>Gray Code</strong></a></span>, find the <strong>binary equivalent</strong> of the number <strong>n</strong>. Return the <strong>decimal representation</strong> of the <strong>binary equivalen</strong>t.</span></p>
