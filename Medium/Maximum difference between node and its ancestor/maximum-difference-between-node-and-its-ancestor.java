...
class Tree
{
    ...
    int maxDiff(Node root)
    {
        ...
        difference(root.left, root.data);   // left
        difference(root.right, root.data);  // right
        
        return ans;
    }
    
    static void difference(Node root, int max){
        if (root == null) {
            return;
        }
        ...
        difference(root.left, max);
        difference(root.right, max);
    }
}
