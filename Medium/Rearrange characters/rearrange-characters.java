...
class Solution
{
	public static String rearrangeCharacters(String str) {
		...
		//code here
		StringBuilder rearrangedString = new StringBuilder(str);
        ...
        while (highestFrequency > 0 && index < str.length()) {
            rearrangedString.setCharAt(index, mostFrequentChar);
            highestFrequency--;
            index += 2;
        }
        ...
        for (Map.Entry<Character, Integer> entry : charFrequency.entrySet()) {
            ...
            while (frequency > 0) {
                ...
                rearrangedString.setCharAt(index, entry.getKey());
                frequency--;
                index += 2;
            }
        }
